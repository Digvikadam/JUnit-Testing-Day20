 ...
 * Validating use the regex program
 */
...
public class UserRegistration {
    ...
    /* method login to validation of login value should have minimum eight value data
     * @param name return boolean value
     */
    ...
    //create method to validation of login have at least one upper value data
    ...
    //create method to validation one special value data
